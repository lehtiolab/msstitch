...
def build_peptidetable(pqdb, header, headerfields, isobaric=False, precursor=False,
    ...
    fill_mergefeature(outpeptide, iso_fun, ms1_fun, empty_return, fdr_fun, pep_fun,
